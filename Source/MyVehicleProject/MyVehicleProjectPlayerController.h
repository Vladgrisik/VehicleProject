...
#include "MyVehicleProjectPlayerController.generated.h"

class UInputMappingContext;
class AMyVehicleProjectPawn;
class UMyVehicleProjectUI;
 ...
 */
UCLASS(abstract)
class MYVEHICLEPROJECT_API AMyVehicleProjectPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AMyVehicleProjectPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UMyVehicleProjectUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UMyVehicleProjectUI> VehicleUI;
