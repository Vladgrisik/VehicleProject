...
#include "MyVehicleProjectSportsCar.h"
#include "MyVehicleProjectSportsWheelFront.h"
#include "MyVehicleProjectSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AMyVehicleProjectSportsCar::AMyVehicleProjectSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyVehicleProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyVehicleProjectSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyVehicleProjectSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyVehicleProjectSportsWheelRear::StaticClass();
