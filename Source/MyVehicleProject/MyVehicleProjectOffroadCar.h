...
#include "MyVehicleProjectOffroadCar.generated.h"

/**
 *  Offroad car wheeled vehicle implementation
 */
UCLASS(abstract)
class MYVEHICLEPROJECT_API AMyVehicleProjectOffroadCar : public AMyVehicleProjectPawn
{
	GENERATED_BODY()
