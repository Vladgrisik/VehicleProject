...
#include "MyVehicleProjectOffroadCar.h"
#include "MyVehicleProjectOffroadWheelFront.h"
#include "MyVehicleProjectOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AMyVehicleProjectOffroadCar::AMyVehicleProjectOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMyVehicleProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMyVehicleProjectOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMyVehicleProjectOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMyVehicleProjectOffroadWheelRear::StaticClass();
